...
const typedHome = new Typed("#home__typed", {
  strings: ["Web Developer", "Freelancer", "Full Stack Enthusiast"],
  typeSpeed: 80,
  backSpeed: 40,
  backDelay: 2000,
  loop: true,
...
window.sr = ScrollReveal({origin: 'top', distance: '60px', duration: 2000, reset: true });
...
sr.reveal('.footer__signature', {delay: 150, origin: 'bottom'})